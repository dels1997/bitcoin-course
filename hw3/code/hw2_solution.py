...
def output_data(secret_string, message):
    # Generating my private key:
    secret = hash256(bytes(secret_string, encoding='UTF-8'))
    ...
    # Signing a message:
    message = hash256(bytes(message, 'UTF-8'))
...
print('first address output: ')
output_data('Dels1', 'This course is boring!')
print('second address output: ')
output_data('Dels2', 'This course is boring!')
'''
