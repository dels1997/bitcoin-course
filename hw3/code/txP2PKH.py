...
#   Creating transactions: send to a p2sh address (but not the spend)
...
# newAddress = 'n1kJtzTUR3SCXXJaLwuJ17NYYFryqBXhfE'

# # First, we need to know which output we will be spending
# tx_hash1 = 'b8e47b6abe7e7ec69a5bda03d4833599d9c04dafb5b61804af1f0cedc9481217'
# tx_index1 = 0

# # Second output we will be spending.
# tx_hash2 = '87fb227afe62f3846830bbb7e6f14aa5a21342dafe2a255dfefdc7d56b34dc5e'
# tx_index2 = 0
...
# newInput1 = TxIn(bytes.fromhex(tx_hash1),tx_index1)
# print(newInput1)
# print(newInput1.value(True)) #need to put True for testnet; othewise fetch will return an error

# # Defining the second input of our transaction.
# newInput2 = TxIn(bytes.fromhex(tx_hash2),tx_index2)
# print(newInput2)
# print(newInput2.value(True)) #need to put True for testnet; othewise fetch will return an error


# # To define the output, we need an address
# targetAddress = 'mtoadNYwKHRASQQgVtALfDhApXsiqSXYBx' # This is a faucet
...
# # First, we need to know which output we will be spending
# tx_hash = 'a00766ec92e998dc3ec6799c8fb1969262ec6446b10acb88af4fcfca5bf6303a'
# tx_index = 0
...
# # To define the output, we need an address
# targetAddress1 = 'mohjSavDdQYHRYXcS3uS6ttaHP8amyvX78' # This is a faucet
# # Since it's a p2pkh address we generate the script for this
# ScriptPubkey1 = p2pkh_script_from_address(targetAddress1)
# # input value = 68472523 output 58472523
# newOutput1 = TxOut(200,ScriptPubkey1)

# # To define the output, we need an address
# targetAddress2 = '2N9KSwqsWgzRHV7gUYkXjjjTn2kaaBSJ4ao'
# # Since it's a p2pkh address we generate the script for this
# ScriptPubkey2 = p2sh_script_from_address(targetAddress2)
# # Define the output, leave some transaction fee here output = 1000, txfee = 9000
# newOutput2 = TxOut(200,ScriptPubkey2)

# # Define a new testnet transaction
# newTx = Tx(1,[newInput],[newOutput1, newOutput2],0,True)

# # We need to sign our input
# # For this, we need the private key that controls this output:
# secret = hash256(b'Dels2')
...
# print(hash256(bytes.fromhex(newTx.serialize().hex()))[::-1].hex())