...
class FullBlock:
    ...
    def parse(cls, s):
        ...
        # initialize class
        return cls(version, prev_block, merkle_root, timestamp, bits, nonce, nr_trans, txs)
    ...
    def serialize(self):
        ...
        # nonce - 4 bytes
        result += self.nonce
        # encode_varint on the number of transactions
        # result += encode_varint(self.nr_trans) # or len(self.txs)
